...
class CaTSv2_Model(nn.Module):
    ...
    def __init__(self, d_model: int = 1024, nhead: int = 16, num_encoder_layers: int = 4, 
        ...
        """
        super(CaTSv2_Model, self).__init__()

...
class FOPAS_Model(nn.Module):
    ...
    def __init__(self):
        ...
        super(FOPAS_Model, self).__init__()
        ...
        self.fc3_ozone    = nn.Linear(800, 1)
        self.fc3_pwv      = nn.Linear(800, 1)
        self.fc3_aerosols = nn.Linear(800, 1)

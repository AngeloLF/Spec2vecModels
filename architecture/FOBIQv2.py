...
class FOBIQv2_Model(nn.Module):
    """
    FOBIQ : Finding Ozone Before I Quite
    """
    ...
    def __init__(self):
        ...
        super(FOBIQv2_Model, self).__init__()
    ...
    def forward(self, x):
        ...
        return 250 + 100 * torch.sigmoid(x)
...
class FOBIQv2_Dataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        ozoneVal = np.load(self.spectrum_files[idx])[0]
        spectrum = np.array([ozoneVal]).astype(np.float32)

...
class CaTSv3_Model(nn.Module):
    ...
    def __init__(self, d_model: int = 2048, nhead: int = 16, num_encoder_layers: int = 4, 
        ...
        """
        super(CaTSv3_Model, self).__init__()

...
from architecture_SotSu import SotSu_Model, SotSu_Dataset
...
train_dataset = SotSu_Dataset(train_image_dir, train_spectrum_dir)
valid_dataset = SotSu_Dataset(valid_image_dir, valid_spectrum_dir)

...
def criterion(outputs, spectra): # MSLE
    outputs_pos = torch.relu(outputs)
    spectra_pos = torch.relu(spectra)
    return nn.MSELoss()(torch.log(1 + outputs_pos), torch.log(1 + spectra_pos))
